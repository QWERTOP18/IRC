...
/*   Updated: 2025/05/15 14:07:13 by ymizukam         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
public:
    ...
    const std::string &getKey() const { return m_mode.b_key; }
    int getLimit() const { return m_mode.b_limit; }
    MODE getMode() const { return m_mode; }
    void setTopic(const std::string &topic) { m_topic = topic; }
    void setKey(const std::string &key) { m_mode.b_key = key; }
    void setLimit(int limit) { m_mode.b_limit = limit; }
